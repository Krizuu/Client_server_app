...
{
    public ClientThread(String localFolder, String username, String ip, int port, Object o){}
        ...
        private ArrayList<FileEntry> getFilesHdd()
        {
            ...
            for(String fPath : listHdd)
            {
                ...
                else
                {
                    ...
                    filesHdd.add(new FileEntry(file.getName(), 0, file.getPath().replace("\\", "\\\\"), size, split[split.length-2], "local"));
                }
            }
            return filesHdd;
        }
    ...
    public static String login2(String username)
    {
        System.out.println("login "+username);
        return String.valueOf("Users");
    }
    public static String logout2(String username)
    {
        System.out.println("logout "+username);
        return String.valueOf("Users");
    }
    public void setFilesLocal2(ArrayList<FileEntry> filesLocal)
    {
        System.out.println("Test client end well");
        this.filesLocal = filesLocal;
    }
    public void setFilesServer2(ArrayList<FileEntry> filesServer)
    {
        System.out.println("Test server end well");
        this.filesServer = filesServer;
    }
    public ArrayList<FileEntry> getDownloadList2() {
        ArrayList<FileEntry> list = (ArrayList<FileEntry>)filesServer.clone();
        for(Iterator<FileEntry> i = list.iterator();i.hasNext();)
        {
            FileEntry f = i.next();
        ...
        System.out.println("Test list downloaded end well");
        return list;
    }
//    public void getDownloadList(ArrayList<FileEntry> filesServer) {
//        this.filesLocal = filesServer;
//    }
